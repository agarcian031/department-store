...
import { Card, Header, Divider, Button, Icon, DropdownHeader } from "semantic-ui-react";
import DepartmentForm from "./DepartmentEditForm";
  ...
  const renderDepartments = () => {
    ...
    return departments.map((department) => (
      <Card color="blue" key={department.id}>
        {editing ? (
          <Card.Content>
            <DepartmentForm {...props} edit={props.edit} toggleEdit={toggleEdit} />
          </Card.Content>
        ) : (
          <Card.Content>
